  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <svg className="w-10 h-10 flex-shrink-0" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Cap skullcap */}
        <path d="M82 78V85C82 96 118 96 118 85V78" fill="#00CED1" />
        {/* Cap Tassel */}
        <path d="M100 68L132 80C134 85 134 92 134 100" stroke="#008B8B" strokeWidth="3.5" strokeLinecap="round" fill="none" />
        <circle cx="134" cy="102" r="4.5" fill="#008B8B" />
      ...
      {showText && (
        <div className="flex flex-col justify-center leading-none">
          <div className="font-heading font-extrabold text-xl tracking-tight text-slate-800">
            <span className="text-[#008B8B]">Info</span>
            <span className="text-[#00CED1] font-semibold">-Hub</span>
          </div>
          <span className="text-[7px] uppercase font-bold tracking-[0.22em] text-[#008B8B] mt-1.5">

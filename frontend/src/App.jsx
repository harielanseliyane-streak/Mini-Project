      ...
      <AuthProvider>
        ...
        <div className="min-h-screen bg-slate-50 body-bg transition-colors duration-300">
          ...
          <Routes>
            ...
            <Route path="/about"               element={<div className="min-h-screen pt-24 px-4 max-w-3xl mx-auto text-slate-600"><h1 className="font-heading text-3xl font-bold text-slate-800 mb-4">About InfoHub</h1><p>InfoHub is an AI-powered College Discovery, Event Management, Scholarship, Internship, and Career Guidance ecosystem connecting students across India with premium educational resources.</p></div>} />
            <Route path="/contact"             element={<div className="min-h-screen pt-24 px-4 max-w-3xl mx-auto text-slate-600"><h1 className="font-heading text-3xl font-bold text-slate-800 mb-4">Contact Us</h1><p>Email: contact@info-hub.in | Support: support@info-hub.in | Hotline: +91 44-2235-7004</p></div>} />
            <Route path="/help"                element={<div className="min-h-screen pt-24 px-4 max-w-3xl mx-auto text-slate-600"><h1 className="font-heading text-3xl font-bold text-slate-800 mb-4">Help &amp; Support</h1><p>Please use our floating AI assistant chatbot in the bottom right corner of the page for real-time recommendations, career guides, or college cutoff enquiries.</p></div>} />
